///FMODGMS_Sys_Set_OutputModeWithCheck(outputMode)

/*var can_change_output_mode = true;

switch (argument[0])
{
    // Can't be used ever
    case FMODGMS_OUTPUTTYPE_UNKNOWN:    // Only used in Get function
    case FMODGMS_OUTPUTTYPE_WIIU:       // No Wii U export :(
    {
        can_change_output_mode = false;
    }
