...
hp = 1; //HP left
pow = obj_lakitub.pow; //Damage dealt (this can be the maximum damage recieved by this enemy)
def = obj_lakitub.def; //Defense to damage
spd = obj_lakitub.spd; //Speed for turns
