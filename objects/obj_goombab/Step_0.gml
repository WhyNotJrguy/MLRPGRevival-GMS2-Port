...
else
{
    ...
    if moveto = 1
    {
        ...
        sprite_index = spr_goombawalk stance = 0;
    ...
    if moveto = 2
    {
        mp_linear_step(obj_mariob.x,obj_mariob.y,2,0); //Attack Mario
        sprite_index = spr_goombaattack stance = 0;
        obj_mariob.stance = 3; //Battle stance
        obj_luigib.stance = 3; //Battle stance
    }
    ...
    if moveto = 4
    {
        mp_linear_step(obj_luigib.x,obj_luigib.y,1,0); //Attack Luigi
        sprite_index = spr_goombaattack stance = 0;
        obj_mariob.stance = 3; //Battle stance
        obj_luigib.stance = 3; //Battle stance
    }
