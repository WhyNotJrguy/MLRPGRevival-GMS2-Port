...
else
{
    ...
    if moveto = 1
    {
        ...
        sprite_index = spr_bowserwalk stance = 0;
        obj_mariob.stance = 3; //Battle stance hammer
        obj_luigib.stance = 3; //Battle stance hammer
    }
    ...
    if moveto = 2
    {
        ...
        sprite_index = spr_bowserattack stance = 0;
    }
