image_speed = .275;
stance = 1;
headz = 77; //Height that player will land on
hurt = 0;
hurttime = 10;
turndone = 0;
moveto = 0;
...
name = "Bowser (LV 35)"; //Name of the enemy

lvl = 35; //Level
experience = 10 //9999; //Experience recieved after the battle
coins = 200; //Coins recieved after the battle

hp = 100 //480; //HP left
pow = 68; //Damage dealt (this can be the maximum damage recieved by this enemy)
def = 22; //Defense to damage
