...
name = "Shy Guy (LV 7)"; //Name of the enemy

lvl = 7; //Level
experience = 60; //Experience recieved after the battle
coins = 15; //Coins recieved after the battle

hp = 40; //HP left
pow = 12; //Damage dealt (this can be the maximum damage recieved by this enemy)
def = 3; //Defense to damage
